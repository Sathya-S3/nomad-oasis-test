![docker image](https://github.com/Sathya-S3/nomad-oasis-test/actions/workflows/docker-publish.yml/badge.svg)
...
2. Clone the repository or download the repository as a zip file.
    ...
    ```sh
    git clone https://github.com/Sathya-S3/nomad-oasis-test.git
    cd nomad-oasis-test
    ```
    ...
    ```sh
    curl-L -o nomad-oasis-test.zip "https://github.com/Sathya-S3/nomad-oasis-test/archive/main.zip"
...
your `docker-compose.yaml` with `ghcr.io/sathya-s3/nomad-oasis-test:main` for the services
...
```
docker pull ghcr.io/sathya-s3/nomad-oasis-test/jupyter:main
```
...
_I get an_ `Error response from daemon: Head "https://ghcr.io/v2/Sathya-S3/nomad-oasis-test/manifests/main": unauthorized`
