...
```sh
curl -L -o nomad-oasis.zip "https://github.com/Sathya-S3/nomad-oasis-test/raw/main/nomad-oasis.zip"
```
 ...
 *I get an* `Error response from daemon: Head "https://ghcr.io/v2/Sathya-S3/nomad-oasis-test/manifests/main": unauthorized`
